...
namespace ETravel.Nps.DataAccess
{
    ...
    public sealed class SessionManager
    {
        ...
        private static ISessionFactory BuildSessionFactory()
        {
            try
            {
                ...
                .Database(
                MsSqlConfiguration.MsSql2008.ConnectionString(Properties.Settings.Default.Database).AdoNetBatchSize(256))
        ...
        private const string SessionKey = "ETravel.Nps.DataAccess.UoW.Session";
        private const string TransactionKey = "ETravel.Nps.DataAccess.UoW.Transaction";
    }
}
